...
//     if idx >= 0 && idx < (WIDTH * HEIGHT) as isize {
...
//         // First cube
//         for cube_x in (-cube_width as isize..cube_width as isize)
//             .step_by(INCREMENT_SPEED as usize)
//             .map(|x| x as f32)
//         {
//             for cube_y in (-cube_width as isize..cube_width as isize)
//                 .step_by(INCREMENT_SPEED as usize)
//                 .map(|y| y as f32)
//             {
